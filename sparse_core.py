...
class Masking(object):
    ...
    def pruning(self, step):
        ...
        final_iter =  int((self.args.final_prune_epoch * self.args.multiplier * int(len(self.train_loader))) / self.prune_every_k_steps)
        ini_iter =  int(self.args.init_prune_epoch * self.args.multiplier * (int(len(self.train_loader))) / self.prune_every_k_steps)
    ...
    def add_module(self, module):
        ...
        for name, tensor in module.named_parameters():
            if 'attn.spatial_gating_unit.conv_spatial.weight' in name:
